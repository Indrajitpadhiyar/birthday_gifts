    ...
    >
      ...
      <div className="absolute inset-0">
        <Canvas shadows>
          ...
          <spotLight position={[10, 10, 10]} angle={0.3} penumbra={1} intensity={showMessage ? 1.5 : 1} castShadow />
          <pointLight position={[-10, -10, -10]} intensity={showMessage ? 0.6 : 0.3} color="#FF69B4" />
        ...
        {showMessage && (
          ...
          >
            <div className="glass rounded-3xl p-8 md:p-12 border-2 border-primary/30 shadow-[0_0_60px_rgba(255,215,0,0.6)] relative overflow-hidden">
              ...
              >
                <span className="block mb-4">Happy Birthday, my special one! 🎉💖</span>
                <span className="block mb-4">Every moment with you is a memory I treasure 💫</span>
                <span className="block mb-4">May your smile shine brighter than these candles 🕯️✨</span>
                <span className="block mb-4">I hope your day is filled with happiness, love, and magic! 🌈💝</span>
                <span className="block">You deserve all the joy in the world — today and always. 🥰🎂✨</span>
              </motion.p>
            </div>
          </motion.div>
        )}
